...
```{r gtexample, echo=TRUE, include = FALSE, message=FALSE, warning=FALSE, fig.keep='none'}
library(gt)
...
```
![my_table](man/figures/my_table.png)
...
```{r example5, echo = TRUE, include = FALSE, fig.keep='none'}
