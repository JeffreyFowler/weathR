...
```{r example3, message=FALSE, paged.print=FALSE, warning=FALSE, results='asis'}
...
```
[You can click here to view the dynamic map we created.](https://jeffreyfowler.github.io/weathR/man/figures/dynamic_map.html)
